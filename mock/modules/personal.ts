    ...
    children: [
      {
        ...
        component: '/views/dashboard/analysis/backPermission.vue',
      },
      {
        path: 'workplace',
        name: 'workplace',
        meta: {title: '工作台'},
        component: '/views/dashboard/workplace/backPermission.vue',
      },
      {
        path: 'monitor',
        name: 'monitor',
        meta: {title: '监控页'},
        component: '/views/dashboard/monitor/backPermission.vue',
      },
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'Users',
        meta: {title: '用户管理'},
        component: '/views/system/users/backPermission.vue',
      },
      {
        path: 'roles',
        name: 'Roles',
        meta: {title: '角色管理'},
        component: '/views/system/roles/backPermission.vue',
      },
      {
        path: 'menus',
        name: 'Menus',
        meta: {title: '菜单管理'},
        component: '/views/system/menus/backPermission.vue',
      },
      {
        path: 'actions',
        name: 'Actions',
        meta: {title: '动作管理'},
        component: '/views/system/actions/backPermission.vue',
      },
      {
        path: 'permissions',
        name: 'Permissions',
        meta: {title: '权限节点'},
        component: '/views/system/permissions/backPermission.vue',
      },
      {
        path: 'configs',
        name: 'Config',
        meta: {title: '站点配置'},
        component: '/views/system/configs/backPermission.vue',
      }
    ]
  },
];
